...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['username', 'unique', 'targetClass' => self::className(), 'message' => Yii::t('db-label', 'This username has already been taken.')],

            ['username', 'string', 'min' => 2, 'max' => 255],

            ['email', 'required'],
            ['email', 'email'],
            ['email', 'unique', 'targetClass' => self::className(), 'message' => Yii::t('db-label', 'This email address has already been taken')],
